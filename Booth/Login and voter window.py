...
def casting():
    ...
    imgc = imgc.resize((150, 33), Image.ANTIALIAS)
    comp = ImageTk.PhotoImage(imgc)

    img3 = Image.open("compc.png")
    img3 = img3.resize((150, 33), Image.ANTIALIAS)
    ...
    butt3.place(relx=0.415,rely=0.73,relheight=0.09,width=220)
...
def mains():
            ...
            button1.place(relx=0.422, rely=0.27, width=210, relheight=0.08)
            button1.bind('<Button>', click)
